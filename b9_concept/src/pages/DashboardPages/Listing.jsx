...
//       navigate(`/appointments/edit/${appointmentId}`); // <--- Navigate to edit page
//     };
...
const Listing = () => {
  ...
  const handleDelete = async (appointmentId) => {
    try {
      ...
      // Make the DELETE API request to delete the appointment
  ...
  const handleEdit = (appointmentId) => {
    console.log("Edit appointment with ID:", appointmentId); // Check this output
                      ...
                      <tr key={appointment.id}>
                        ...
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                          <div className="flex space-x-3">
                            ...
                            <button
                              onClick={() => handleDelete(appointment.id)} // Use appointment.id here
                              className="text-red-600 hover:text-indigo-900"
                            >
